export default {
  ...
  // Image2 Generation Page
  imageGeneration: {
    title: 'Image2 Generation',
    description: 'Select your OpenAI-group API key and generate or edit images through the gateway.',
    badge: 'Image2 Studio',
    sessionOnly: 'Stored in this browser session only',
    apiKey: 'API Key',
    selectApiKey: 'Select an available OpenAI API Key',
    capability: 'Capability',
    capabilityLoading: 'Checking',
    capabilityUnknown: 'Not selected',
    advancedMode: 'Advanced ready',
    basicMode: 'Basic ready',
    unavailable: 'Unavailable',
    noOpenAIKeys: 'No available OpenAI-group API Key',
    noOpenAIKeysHint: 'Create or enable a key whose group platform is OpenAI first.',
    results: 'Results',
    clearResults: 'Clear',
    noResultsTitle: 'No images yet',
    noResultsHint: 'Generated images stay in page memory as Blob URLs/data URLs only.',
    preview: 'Preview',
    noPreviewTitle: 'Ready to generate',
    noPreviewHint: 'Enter a prompt to generate an image, or pick a thumbnail on the left.',
    download: 'Download',
    promptPanel: 'Prompt / Config',
    promptLabel: 'Prompt',
    promptPlaceholder: 'Describe the image you want, e.g. a commercial product poster, soft lighting, clean background, premium style...',
    referenceImages: 'Reference images',
    uploadReference: 'Upload',
    uploadHint: 'Multipart upload in one request, up to 4 images, 20 MB each.',
    removeReference: 'Remove reference image',
    unsupportedUpload: 'This capability does not declare reference upload support; select a key with input images/uploads/edits support.',
    config: 'Config',
    basicHint: 'Basic mode: Prompt + b64_json only, compatible with free/basic web2api.',
    advancedSettings: 'Advanced options',
    advancedLockedHint: 'Current free/basic capability cannot edit advanced options; use an OpenAI group with advanced image support.',
    advancedModalHint: 'Advanced options only apply when supports_advanced_options is true; with reference images and edits support, requests automatically use /v1/images/edits.',
    advancedSummary: '{model} · {size} · {count} image(s) · {format}',
    model: 'Model',
    size: 'Size',
    count: 'Count',
    maxCountHint: 'Current max: {count}',
    responseFormat: 'Response format',
    responseFormatB64: 'b64_json (recommended)',
    ...
    unsupportedParams: 'Unsupported by current basic capability',
    resetAdvanced: 'Reset',
    saveAdvanced: 'Save',
    endpoint: 'Endpoint',
    routeGeneration: '/v1/images/generations',
    routeEdit: '/v1/images/edits',
    generate: 'Generate',
    generating: 'Generating...',
    promptRequired: 'Please enter a prompt',
    selectKeyRequired: 'Please select an API Key',
    generationSuccess: 'Generated {count} image(s)',
    ...
    capabilityLoadFailed: 'Failed to check image capability',
    downloadFailed: 'Download failed',
    invalidImage: 'Please select an image file',
    imageTooLarge: 'Image is too large, max {size}',
    maxReferencesReached: 'You can upload up to {count} reference images',
    optionAuto: 'Auto',
    optionLow: 'Low',
    optionMedium: 'Medium',
    optionHigh: 'High',
    optionTransparent: 'Transparent',
    optionOpaque: 'Opaque',
  },
