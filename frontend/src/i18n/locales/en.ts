export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      probeModelsLoading: 'Fetching...',
      probeModelsSuccess: 'Fetched {count} model(s)',
      probeModelsEmpty: 'No models returned from upstream',
      probeModelsFailed: 'Failed to fetch models',
      probeModelsHint: 'Auto-fetch available models from upstream API',
