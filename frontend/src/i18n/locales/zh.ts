export default {
  ...
  imageGeneration: {
    title: 'Image2 生图',
    description: '选择自己的 OpenAI 分组 API Key，通过网关生成或参考图编辑图片。',
    badge: 'Image2 Studio',
    sessionOnly: '仅保存在本次浏览器会话',
    apiKey: 'API Key',
    selectApiKey: '请选择可用的 OpenAI API Key',
    capability: '能力',
    capabilityLoading: '检测中',
    capabilityUnknown: '待选择',
    advancedMode: '高级可用',
    basicMode: '基础可用',
    unavailable: '不可用',
    noOpenAIKeys: '暂无可用的 OpenAI 分组 API Key',
    noOpenAIKeysHint: '请先在 API 密钥页面创建或启用一个分组平台为 OpenAI 的密钥。',
    results: '结果',
    clearResults: '清空',
    noResultsTitle: '暂无图片',
    noResultsHint: '生成结果只会以 Blob URL/数据 URL 保留在当前页面内存中。',
    preview: '预览',
    noPreviewTitle: '等待生成',
    noPreviewHint: '输入 Prompt 后生成图片，或选择左侧缩略图查看大图。',
    download: '下载',
    promptPanel: 'Prompt / 配置',
    promptLabel: 'Prompt',
    promptPlaceholder: '描述你想生成的图片，例如：一张商业产品海报，柔和灯光，干净背景，高级质感...',
    referenceImages: '参考图',
    uploadReference: '上传',
    uploadHint: '支持单次 multipart 上传，最多 4 张，每张不超过 20 MB。',
    removeReference: '移除参考图',
    unsupportedUpload: '当前能力未声明支持参考图上传；请选择支持 input images/uploads/edits 的密钥。',
    config: '配置',
    basicHint: '基础模式：仅 Prompt + b64_json，适配 free/basic web2api。',
    advancedSettings: '高级参数',
    advancedLockedHint: '当前为 free/basic 能力，高级参数不可编辑；请使用支持高级图片能力的 OpenAI 分组。',
    advancedModalHint: '高级参数只在支持 supports_advanced_options 的密钥上生效；参考图存在且支持 edits 时会自动走 /v1/images/edits。',
    advancedSummary: '{model} · {size} · {count} 张 · {format}',
    model: '模型',
    size: '尺寸',
    count: '数量',
    maxCountHint: '当前最多 {count} 张',
    responseFormat: '响应格式',
    responseFormatB64: 'b64_json（推荐）',
    ...
    selectKeyRequired: '请选择 API Key',
    generationSuccess: '已生成 {count} 张图片',
    generationFailed: '生成失败，请稍后重试',
    emptyResponse: '响应中没有可用图片',
    keysLoadFailed: '加载 API Key 失败',
    capabilityLoadFailed: '检测图片能力失败',
    downloadFailed: '下载失败',
    invalidImage: '请选择图片文件',
    imageTooLarge: '图片过大，最大 {size}',
    maxReferencesReached: '最多只能上传 {count} 张参考图',
    optionAuto: '自动',
    optionLow: '低',
    optionMedium: '中',
    optionHigh: '高',
    optionTransparent: '透明',
    optionOpaque: '不透明',
  },
