...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	kiroTokenProvider := service.NewKiroTokenProvider(accountRepository)
	...
	kiroTokenRefresher := service.ProvideKiroTokenRefresher(accountRepository, configConfig, leaderLockCache, db)
