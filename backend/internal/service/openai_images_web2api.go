...
func (s *OpenAIGatewayService) wrapOpenAIImageBackendError(
	...
	if shouldFailoverOpenAIImagesOAuthResponse(statusErr.StatusCode, upstreamMsg, statusErr.ResponseBody) || s.shouldFailoverOpenAIUpstreamResponse(account, statusErr.StatusCode, upstreamMsg, statusErr.ResponseBody) {
