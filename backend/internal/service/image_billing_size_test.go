...
func TestClassifyImageBillingTier(t *testing.T) {
	tests := []struct {
		...
		{name: "official square 1k", size: "1024x1024", wantTier: "1K", wantOK: true},
		{name: "custom 1024 wide defaults 2k", size: "1024X768", wantTier: "2K", wantOK: true},
		{name: "custom valid 2k", size: "1280x768", wantTier: "2K", wantOK: true},
		{name: "official 2k max pixels", size: "2560x1440", wantTier: "2K", wantOK: true},
		{name: "custom over 2k pixels becomes 4k", size: "2560x1600", wantTier: "4K", wantOK: true},
